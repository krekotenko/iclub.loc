...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		if (isset($this->error['usd'])) {
			$data['error_usd'] = $this->error['usd'];
		} else {
			$data['error_usd'] = '';
		}
		...
		if (isset($this->request->post['config_usd'])) {
			$data['config_usd'] = $this->request->post['config_usd'];
		} else {
			$data['config_usd'] = $this->config->get('config_usd');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['config_usd']) {
			$this->error['usd'] = "Не задан курс USD";
		}
