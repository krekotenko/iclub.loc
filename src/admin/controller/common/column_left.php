...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/seo_texts')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_seo_texts'),
                    'href'     => $this->url->link('catalog/seo_texts', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
