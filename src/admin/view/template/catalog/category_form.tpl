...
<div id="content">
              ...
              <div class="table-responsive">
                <table id="attribute" class="table table-striped table-bordered table-hover">
                  ...
                  <tr id="attribute-row<?php echo $attribute_row; ?>">
                    <td class="text-left" style="width: 40%;"><input type="text" name="category_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $category_attribute['name']; ?>" placeholder="Введите имя" class="form-control" /><input type="hidden" name="category_attribute[<?php echo $attribute_row; ?>][id]" value="<?php echo $category_attribute['id']; ?>" class="form-control" /></td>
  ...
  <script type="text/javascript"><!--
      ...
      function addAttribute() {
          ...
          html += '  <td class="text-left" style="width: 20%;"><input type="text" name="category_attribute[' + attribute_row + '][name]" value="" placeholder="Введите имя" class="form-control" /></td>';
         // html += '  <td class="text-left">';
         // html += '<div class="input-group"><input name="category_attribute[' + attribute_row + '][alias]"  placeholder="Введите системное имя" class="form-control" /></div>';
         // html += '  </td>';
