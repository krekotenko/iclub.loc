        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-upc">Штрих код</label>
                <input type="text" name="filter_upc" value="<?php echo $filter_upc; ?>" placeholder="Штрих код" id="input-upc" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
