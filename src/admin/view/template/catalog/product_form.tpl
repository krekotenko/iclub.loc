          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group<?php echo ($hide_upc == true)? ' hide':''; ?>">
                <label class="col-sm-2 control-label" for="input-upc"><span data-toggle="tooltip" title="Штрих-код">Штрих-код</span></label>
                <div class="col-sm-10">
                  <input type="text" name="upc" value="<?php echo $upc; ?>" placeholder="Штрих-код" id="input-upc" class="form-control" />
                    <?php if ($error_upc) { ?>
                        <div class="text-danger"><?php echo $error_upc; ?></div>
                    <?php } ?>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="price" value="<?php echo $price; ?>" data-kurs="<?php echo $kursUsd;?>" placeholder="<?php echo $entry_price; ?>" id="input-price" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price_discount">Скидка (%):</label>
                <div class="col-sm-10">
                  <input type="text" name="price_discount" value="<?php echo $price_discount; ?>" placeholder="Скидка:" id="input-price_discount" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price_discount">Цена со скидкой ($):</label>
                <div class="col-sm-10">
                  <input type="text" name="price_discount_dollars" value="" id="input-price_discount_dollars" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price_discount">Цена со скидкой  (грн):</label>
                <div class="col-sm-10">
                  <input type="text" name="price_discount_uah" value=""  id="input-price_discount_uah" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left"><?php echo $entry_customer_group; ?></td>
                      <td class="text-right"><?php echo $entry_priority; ?></td>
                      <td class="text-right">Текст акции</td>
                      <td class="text-right"><?php echo $entry_price_proc; ?></td>
                      <td class="text-left"><?php echo $entry_date_start; ?></td>
                      <td class="text-left"><?php echo $entry_date_end; ?></td>
                      <td></td>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr id="special-row<?php echo $special_row; ?>">
                      ...
                      <td class="text-right">
                        <textarea name="product_special[<?php echo $special_row; ?>][text]" placeholder="Текст акции" class="form-control"><?php echo $product_special['text']; ?></textarea>
                      </td>
                      <td class="text-right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $product_special['price']; ?>" placeholder="<?php echo $entry_price_proc; ?>" class="form-control" /></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
...
function addSpecial() {
    ...
    html += '  <td class="text-right"><textarea name="product_special[' + special_row + '][text]"  placeholder="Текст акции" class="form-control"></textarea></td>';
	html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][price]" value="" placeholder="<?php echo $entry_price_proc; ?>" class="form-control" /></td>';
...
$("#input-price_discount,#input-price").on('change',function() {
    if($('#input-price_discount').val() > 0) {
        var priceDiscountDollars = $("#input-price").val() - ($('#input-price_discount').val()*$("#input-price").val())/100;
        var priceDiscountUah = $("#input-price").val()* $("#input-price").data('kurs') - ($('#input-price_discount').val()*$("#input-price").val() * $("#input-price").data('kurs'))/100;

        $("#input-price_discount_dollars").val(priceDiscountDollars);
        $("#input-price_discount_uah").val(priceDiscountUah);
    }
});

      if($('#input-price_discount').val() > 0 && $('#input-price').val()) {
          var priceDiscountDollars = $("#input-price").val() - ($('#input-price_discount').val()*$("#input-price").val())/100;
          var priceDiscountUah = $("#input-price").val()* $("#input-price").data('kurs') - ($('#input-price_discount').val()*$("#input-price").val() * $("#input-price").data('kurs'))/100;
