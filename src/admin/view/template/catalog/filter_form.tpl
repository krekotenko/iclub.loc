          ...
          <table id="filter" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="filter-row<?php echo $filter_row; ?>">
                ...
                <td class="text-right"><input type="text" name="filter[<?php echo $filter_row; ?>][filter_keyword]" value="<?php echo $filter['filter_keyword']; ?>" placeholder="Alias" id="input-filter_keyword" class="form-control" /></td>
...
function addFilterRow() {
	...
	html += '  <td class="text-right"><input type="text" name="filter[' + filter_row + '][filter_keyword]" value="" placeholder="Alias" id="input-filter_keyword" class="form-control" /></td>';
