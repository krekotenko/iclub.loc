        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-admin-limit"><span data-toggle="tooltip" title="Курс USD">Курс USD</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_usd" value="<?php echo $config_usd; ?>" placeholder="Курс USD" id="input-admin-limit" class="form-control" />
                  <?php if ($error_usd) { ?>
                  <div class="text-danger"><?php echo $error_usd; ?></div>
                  <?php } ?>
                </div>
              </div>
            </div>
