<?php echo $header; ?>
                                        ...
                                        <tbody id="additional-description<?php echo $module_row; ?>">
                                            <tr>
                                                <td class="text-left">
                                                    ...
                                                    <?php foreach ($languages as $language) { ?>
                                                        <div id="">
                                                            <textarea name="article_addition_description[<?php echo $module_row ?>][<?php echo $language['language_id']; ?>][additional]" class="form-control summernote" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" class="form-control"><?php if(isset($additional_description[$language['language_id']]['additional'])) {echo $additional_description[$language['language_id']]['additional'];} else { echo ""; }  ?></textarea>
    ...
    <script type="text/javascript">
        ...
        function addDescription() {
            ...
            <?php foreach ($languages as $language) { ?>
            html += '<div id="">'
            html += '	<textarea name="article_addition_description[' + module_row + '][<?php echo $language['language_id']; ?>][additional]" id="description-' + module_row + '-<?php echo $language['language_id']; ?>" class="form-control summernote" class="form-control"></textarea> <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" align="top" />';
            html += '</div>';
            <?php } ?>
            html += '           ';
            html += '       </td>';
