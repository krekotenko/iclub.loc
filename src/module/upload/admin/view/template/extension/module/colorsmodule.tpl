            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mymodul" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="colorsmodule_status" id="input-status" class="form-control">
                                <?php if ($colorsmodule_status) { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_alias; ?></label>
                        <div class="col-sm-10">
                            <input type="text" disabled value="colorsmodule">
                        </div>
                    </div>
                </form>
            </div>
