...
<div class="products-wrapper js_products__item">
    <div class="products__item">
        <div class="products__other">
            <ul>
                <?php foreach ($product['similar'] as $key => $color) : ?>
                <li>
                    <a href="#" class="<?php echo $key == 0 ? 'active' : '' ?>" style="background-color: <?php echo $color; ?>"></a>
                </li>
                <?php endforeach; ?>
            </ul>
        </div>
        ...
        <div class="products__body">
            ...
            <div class="products__buttons">
                <a href="#single-product" class="btn btn-buy js-btn-buy inline-group">
